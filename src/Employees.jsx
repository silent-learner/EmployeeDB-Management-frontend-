    ...
    <div className="container">
      ...
      <form>
        ...
        <div className="row m-2">
          <div className="col">
            <p>Date of Joining</p>
            <DateRangePicker appearance="default" placeholder="Select range of dates" style={{"width" : "100%"}} onChange={onRangechange} />
          </div>
          <div className="col">
          ...
          <div className="col">
            ...
            <input id="country" type="text" className="form-control" placeholder="Country" value={country}
      ...
      <div className="row">
        ...
        }) : <p className="text-center mt-3" style={{"fontSize" : "1.5rem"}}>No employees</p>}
      </div>
    </div>
  );
};
